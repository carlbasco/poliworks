...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('construction', '0011_auto_20200605_1340'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='typeofproject',
            field=models.CharField(choices=[('General Construction', 'General Construction'), ('Industrial Cement Flooring Finish', 'Industrial Cement Flooring Finish'), ('Self-Leveling Floor Applcation', 'Self-Leveling Floor Applcation'), ('Interior Fit-out Works', 'Interior Fit-outWorks'), ('Concrete Countertops', 'Concrete Countertops')], max_length=255, null=True, verbose_name='Project Type'),
        ),
        migrations.AlterField(
