...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('construction', '0004_auto_20200707_1622'),
    ]

    operations = [
        migrations.AlterField(
            model_name='estimateimage',
            name='image',
            field=models.FileField(blank=True, null=True, upload_to=construction.models.estimate_upload_path, verbose_name='Image/Design/Reference'),
        ),
        migrations.AlterField(
