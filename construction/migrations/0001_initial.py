# Generated by Django 3.0.7 on 2020-07-06 04:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Pending', 'Pending'), ('On-going', 'On-going'), ('Completed (Overdue)', 'Completed (Overdue)'), ('Completed', 'Completed')], default='Pending', max_length=255)),
                ('lotarea', models.CharField(blank=True, help_text='Please indicate if square meter, hectare, acre', max_length=255, verbose_name='Lot Area')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('whm', models.ForeignKey(blank=True, limit_choices_to={'groups__name': 'Warehouseman'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dailyreport_whm', to=settings.AUTH_USER_MODEL, verbose_name='Warehouseman')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Rejected', 'Rejected'), ('Pending', 'Pending'), ('Accepted', 'Accepted')], default='Pending', max_length=255, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('requisition_no', models.IntegerField(null=True, unique=True, verbose_name='requisition number')),
                ('date', models.DateField(default=datetime.date.today, verbose_name='Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status2', models.CharField(blank=True, choices=[('Incomplete', 'Incomplete'), ('Not Received', 'Not Received'), ('Complete', 'Complete')], max_length=255, null=True, verbose_name='Action')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.IntegerField(choices=[(3, 'medium'), (5, 'high'), (1, 'low')], default=1, verbose_name='Level')),
                ('status', models.CharField(choices=[('Done', 'Done'), ('Pending', 'Pending'), ('On-going', 'On-going')], default='Pending', max_length=255, verbose_name='Status')),
